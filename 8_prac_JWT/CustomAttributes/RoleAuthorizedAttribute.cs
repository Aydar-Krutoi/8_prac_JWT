...
namespace _8_prac_JWT.CustomAttributes
{
    ...
    public class RoleAuthorizedAttribute : Attribute, IAsyncActionFilter
    {
        ...
        public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
        {
            ...
            {
                context.Result = new JsonResult(new { error = "Нет сессии" }) { StatusCode = 401 };
                return;
            }
            ...
            {
                context.Result = new JsonResult(new { error = "Нет прав" }) { StatusCode = 401 };
                return;
            }
